...
- public/examples/: synthetic QC datasets for a handful of common clinical tests (sodium, potassium, lipids, glucose, calcium), each demonstrating a different Westgard rule violation (or a clean in-control run). Loadable directly from the demo UI.
